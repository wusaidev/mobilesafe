...
import com.wusai.mobilesafe.utils.StreamUtil;
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        initDB();
        //创建快捷方式
        boolean hasShortCut=SpUtil.getBoolean(getApplicationContext(), ConstantValue.HAS_SHORTCUT,false);
        if(!hasShortCut){
        	initShortCut();
        }
    }
	private void initShortCut() {
		...
		Intent relateInstent=new Intent(this,SplashActivity.class);
		intent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, relateInstent);
...
//		startActivity(intent);
	...
	protected void enterHome() {
		if(SpUtil.getBoolean(getApplicationContext(), 
				ConstantValue.OPEN_ADDRESS, false)){
